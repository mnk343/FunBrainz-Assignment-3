...
namespace FunBrainz {
	...
	/// <summary>
	/// Summary for drawshape
	/// </summary>
	public ref class drawshape : public System::Windows::Forms::Form
	{
	public:
		drawshape(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->timer1->Tick += gcnew System::EventHandler(this, &drawshape::timer1_Tick);
			// 
			// label3
			// 
			...
			this->label2->Click += gcnew System::EventHandler(this, &drawshape::label2_Click);
			// 
			// label8
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &drawshape::button2_Click);
			// 
			// textBox1
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &drawshape::button1_Click);
			// 
			// label1
			// 
			...
			this->pictureBox12->Click += gcnew System::EventHandler(this, &drawshape::pictureBox12_Click);
			// 
			// pictureBox11
			// 
			...
			this->pictureBox11->Click += gcnew System::EventHandler(this, &drawshape::pictureBox11_Click);
			// 
			// pictureBox10
			// 
			...
			this->pictureBox10->Click += gcnew System::EventHandler(this, &drawshape::pictureBox10_Click);
			// 
			// pictureBox9
			// 
			...
			this->pictureBox9->Click += gcnew System::EventHandler(this, &drawshape::pictureBox9_Click);
			// 
			// pictureBox8
			// 
			...
			this->pictureBox8->Click += gcnew System::EventHandler(this, &drawshape::pictureBox8_Click);
			// 
			// pictureBox7
			// 
			...
			this->pictureBox7->Click += gcnew System::EventHandler(this, &drawshape::pictureBox7_Click);
			// 
			// pictureBox6
			// 
			...
			this->pictureBox6->Click += gcnew System::EventHandler(this, &drawshape::pictureBox6_Click);
			// 
			// pictureBox5
			// 
			...
			this->pictureBox5->Click += gcnew System::EventHandler(this, &drawshape::pictureBox5_Click);
			// 
			// pictureBox4
			// 
			...
			this->pictureBox4->Click += gcnew System::EventHandler(this, &drawshape::pictureBox4_Click);
			// 
			// pictureBox3
			// 
			...
			this->pictureBox3->Click += gcnew System::EventHandler(this, &drawshape::pictureBox3_Click);
			// 
			// pictureBox2
			// 
			...
			this->pictureBox2->Click += gcnew System::EventHandler(this, &drawshape::pictureBox2_Click);
			// 
			// pictureBox1
			// 
			...
			this->pictureBox1->Click += gcnew System::EventHandler(this, &drawshape::pictureBox1_Click);
			// 
			// label11
			// 
			...
			this->label11->Click += gcnew System::EventHandler(this, &drawshape::label11_Click);
			// 
			// panel2
			// 
			...
			this->pictureBox16->Location = System::Drawing::Point(19, 85);
			this->pictureBox16->Name = L"pictureBox16";
			this->pictureBox16->Size = System::Drawing::Size(180, 15);
			this->pictureBox16->SizeMode = System::Windows::Forms::PictureBoxSizeMode::CenterImage;
			this->pictureBox16->TabIndex = 46;
			this->pictureBox16->TabStop = false;
			this->pictureBox16->Click += gcnew System::EventHandler(this, &drawshape::pictureBox16_Click);
			// 
			// pictureBox15
			// 
			this->pictureBox15->BackColor = System::Drawing::Color::Black;
			this->pictureBox15->Location = System::Drawing::Point(19, 58);
			this->pictureBox15->Name = L"pictureBox15";
			this->pictureBox15->Size = System::Drawing::Size(180, 10);
			this->pictureBox15->SizeMode = System::Windows::Forms::PictureBoxSizeMode::CenterImage;
			this->pictureBox15->TabIndex = 47;
			this->pictureBox15->TabStop = false;
			this->pictureBox15->Click += gcnew System::EventHandler(this, &drawshape::pictureBox15_Click);
			// 
			// pictureBox14
			// 
			this->pictureBox14->BackColor = System::Drawing::Color::Black;
			this->pictureBox14->Location = System::Drawing::Point(19, 35);
			this->pictureBox14->Name = L"pictureBox14";
			this->pictureBox14->Size = System::Drawing::Size(180, 8);
			this->pictureBox14->SizeMode = System::Windows::Forms::PictureBoxSizeMode::CenterImage;
			this->pictureBox14->TabIndex = 46;
			this->pictureBox14->TabStop = false;
			this->pictureBox14->Click += gcnew System::EventHandler(this, &drawshape::pictureBox14_Click);
			// 
			// pictureBox13
			// 
			...
			this->pictureBox13->Size = System::Drawing::Size(180, 6);
			this->pictureBox13->SizeMode = System::Windows::Forms::PictureBoxSizeMode::CenterImage;
			this->pictureBox13->TabIndex = 0;
			this->pictureBox13->TabStop = false;
			this->pictureBox13->Click += gcnew System::EventHandler(this, &drawshape::pictureBox13_Click);
			// 
			// Backbutton
			// 
			this->Backbutton->Location = System::Drawing::Point(86, 555);
			this->Backbutton->Name = L"Backbutton";
			this->Backbutton->Size = System::Drawing::Size(144, 35);
			this->Backbutton->TabIndex = 46;
			this->Backbutton->Text = L"Back";
			this->Backbutton->UseVisualStyleBackColor = true;
			this->Backbutton->Click += gcnew System::EventHandler(this, &drawshape::Backbutton_Click);
			// 
			// drawshape
			// 
			...
			this->Name = L"drawshape";
			this->Text = L"drawshape";
			this->Load += gcnew System::EventHandler(this, &drawshape::drawshape_Load);
			this->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &drawshape::drawshape_Paint);
			this->MouseClick += gcnew System::Windows::Forms::MouseEventHandler(this, &drawshape::drawshape_MouseClick);
		...
		Point pt3;
		Point pt4;
		array<Point>^ local;	  //local......it will store all clicked points and all points of line 1 and line 2	..if the array fillup..user cant draw points
		array<Point>^ line_no;		//it will store endpoints of a line..
...
#pragma endregion
	private: System::Void drawshape_Load(System::Object^  sender, System::EventArgs^  e) {
...
private: System::Void drawshape_Paint(System::Object^  sender, System::Windows::Forms::PaintEventArgs^  e) {
			  int l, m,k;
...
private: System::Void drawshape_MouseClick(System::Object^  sender, System::Windows::Forms::MouseEventArgs^  e) {
