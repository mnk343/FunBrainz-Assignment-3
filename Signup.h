...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label7->Location = System::Drawing::Point(106, 147);
			...
			this->label6->Location = System::Drawing::Point(106, 227);
			...
			this->label5->Location = System::Drawing::Point(103, 196);
			...
			this->Emailtxt->TextChanged += gcnew System::EventHandler(this, &Signup::Emailtxt_TextChanged);
			// 
			// Mobiletxt
			// 
			...
			// UserNametxt
			// 
			this->UserNametxt->Location = System::Drawing::Point(251, 16);
			...
			// Signupbtn
			// 
			this->Signupbtn->Location = System::Drawing::Point(299, 534);
			...
			// button2
			// 
			this->button2->Location = System::Drawing::Point(42, 534);
			...
			this->label12->Location = System::Drawing::Point(104, 430);
			...
			this->label11->Location = System::Drawing::Point(103, 378);
			...
			// Answertxt
			// 
			this->Answertxt->Location = System::Drawing::Point(251, 425);
			...
			// 
			this->GuardiansFirstNametxt->Location = System::Drawing::Point(251, 466);
			this->GuardiansFirstNametxt->Name = L"GuardiansFirstNametxt";
			this->GuardiansFirstNametxt->Size = System::Drawing::Size(197, 22);
			this->GuardiansFirstNametxt->TabIndex = 38;
			// 
			// GuardiansLastNametxt
			// 
			this->GuardiansLastNametxt->Location = System::Drawing::Point(251, 505);
			this->GuardiansLastNametxt->Name = L"GuardiansLastNametxt";
			this->GuardiansLastNametxt->Size = System::Drawing::Size(197, 22);
			this->GuardiansLastNametxt->TabIndex = 39;
			// 
			// label13
			// 
			this->label13->AutoSize = true;
			this->label13->Location = System::Drawing::Point(108, 469);
			...
			this->label14->Location = System::Drawing::Point(89, 508);
			...
			this->ClientSize = System::Drawing::Size(722, 575);
